 ...
 *         Assessment 4
 * This test is carried out to check the bug that cause
 * the service charge to be zero while performing the
 * hotel check out use case has been resolved. The test is performed
 * without any user input and all the methods call are automated. As there
 * is no method that can be used to check the charge of the
 * room without changing the code, the print output is taken
 * as a confirmation of the bugs that has been reported is solved.
 * */
public class ResolutionBugZeroCharge {
    Hotel hotel;
    Date date;
    Room room;
    Guest guest;
   ...
   */
    ...
    the bug that was reported has been solved.
     */
    @Test
