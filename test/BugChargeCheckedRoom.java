 ...
 * room is being charged for the service. This is done by automating
 * the use case without any user input.
 * */
public class BugChargeCheckedRoom {
    Hotel hotel;
    Date date;
    Room room;
    Guest guest;
    ...
    */
    ...
    public void testBugChargeCheckedRoomCase1() {
        ...
        recordServiceCTL = new RecordServiceCTL(hotel);
        recordServiceCTL.roomNumberEntered(room.getId());
        recordServiceCTL.serviceDetailsEntered(ServiceType.RESTAURANT,150);
    }
   ...
   */
    ...
    public void testBugChargeCheckedRoomCase2() {
        ...
        recordServiceCTL = new RecordServiceCTL(hotel);
        recordServiceCTL.roomNumberEntered(room.getId());
        recordServiceCTL.serviceDetailsEntered(ServiceType.BAR_FRIDGE,150);
    }
   ...
   */
    ...
    public void testBugChargeCheckedRoomCase3() {
        ...
        recordServiceCTL = new RecordServiceCTL(hotel);
        recordServiceCTL.roomNumberEntered(room.getId());
        recordServiceCTL.serviceDetailsEntered(ServiceType.RESTAURANT,100);
